...
const BASE_URL = 'https://accesoriosrizer.vendhq.com/api/2.0';
const LEGACY_BASE_URL = 'https://accesoriosrizer.vendhq.com/api';
const GET_OPTIONS = {
  method: 'GET',
  headers: {
    Authorization: 'Bearer 5ch0PsgXMYkBD9B2rJ97og_9gt76Y5cDulCjG1kc',
  },
};
const POST_OPTIONS = {
  method: 'POST',
